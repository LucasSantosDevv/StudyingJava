...
Objeto portas: essa classe permite gerar um objeto que ira interagir com o objeto carro de outra classe, e como cada
carro geralmente tem de duas a quatro portas, temos um relacionamento de um para 'n'.
*/
...
public class Portas {
    ...
    boolean vidros = false;     //Variáveis

    Portas(int portas){     //Construtor da porta
        this.portas = portas;
    }

    void vidrosAbrir(){     //Metodos dos vidros (abrir)
        vidros = true;
    }
    void vidrosFechar(){        //Metodos dos vidros (fechar)
        vidros = false;
    }
